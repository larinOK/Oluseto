...
class UploadPhoto extends StatefulWidget {
  ...
  UploadPhoto({required this.firebaseCollection});

  @override
  State<StatefulWidget> createState() {
    return UploadPhotoState(firebaseCollection: firebaseCollection);
  }
}
...
class UploadPhotoState extends State<UploadPhoto> {
  ...
  UploadPhotoState({required this.firebaseCollection}) {
